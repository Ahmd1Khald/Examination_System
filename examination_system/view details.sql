...
---------------Provides an overview of courses, including course details , instructor and Exam count.
...
------------Displays exam results, including student answers and correct answers.
select *
from vw_ExamResults
where StdId=8;

-----------Shows the exam schedule, including date, time, intake, and branch.
...
----------Shows courses assigned to instructors, including course details.
